...
const SUBAGENT_TRANSCRIPT_STREAM_LIMIT = 200;
const SUBAGENT_TRANSCRIPT_POLL_MS = 2000;
const SUBAGENT_TRANSCRIPT_REFRESH_DEBOUNCE_MS = 150;
const SUBAGENT_TRANSCRIPT_FOLLOW_THRESHOLD_PX = 48;
